...
import com.enestekin.graphsudoku.common.BaseLogic
import com.enestekin.graphsudoku.common.DispatcherProvider
import com.enestekin.graphsudoku.domain.IGameRepository
import com.enestekin.graphsudoku.domain.IStatisticsRepository
import com.enestekin.graphsudoku.domain.SudokuPuzzle
...
class ActiveGameLogic (
    ...
    private fun cancelStuff() {
        if (timeTracker?.isCancelled == false) timeTracker?.cancel()
        jobTracker.cancel()
    }
